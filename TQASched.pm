...
sub update_history {
	...
	my $select_filter = "and sched_id = $sched_id";
	...
	# otherwise, insert
	my ( $hist_id, $late, $fd, $fn, $hist_trans_num ) = $dbh_sched->selectrow_array( "
	...
	if ( !$hist_id && $fd_q && $fn_q ) {
		...
		( $hist_id, $old_trans_num, $old_feed_date ) = $dbh_sched->selectrow_array( "
